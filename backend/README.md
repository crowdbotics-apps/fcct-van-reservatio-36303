...
## Project Structure
    ...
    ├── fcct_van_reservatio_36303  # Django project configurations
...
1. Clone this repo and `cd fcct_van_reservatio_36303`
...
2. Clone this repo and `cd fcct_van_reservatio_36303`
